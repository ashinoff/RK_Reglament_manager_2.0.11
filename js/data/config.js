...
const APP_CONFIG = {
  ...
  regulations: [
    ...
    {
      id: 'i004-2025',
      title: 'И 004-2025 - Инструкция по учету, порядку применения и обороту бланков актов, номерных пломб и знаков визуального контроля',
      year: 2025,
      enabled: true
    }
    {
      id: 'orp-reglament-2019',
      title: 'Ррегламент взаимодействия исполнителя и заказчика при ограничении/возобновлении режима потребления электроэнергии потребителям',
      year: 2019,
      enabled: true
    }
  ],
